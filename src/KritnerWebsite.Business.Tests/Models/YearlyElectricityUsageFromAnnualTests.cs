...
{
    [TestFixture]
    public class YearlyElectricityUsageTestsFromAnnual
    {
        private YearlyElectricityUsageFromAnnual _subject;

        [Test]
        public void ShouldMatchActualUsageFromSampleData()
        {
            _subject = new YearlyElectricityUsageFromAnnual(2357.22, 17019);
